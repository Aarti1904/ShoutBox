                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger" onclick="deleteConfirmation(`{{$app['id']}}`)">Delete</button>
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <a href=" {{ url('/approvals/approve/'.$app['id']) }}">
...
$.ajax({
type: 'GET',
url: "http://127.0.0.1:8000/approvals/destroy/" + id,
