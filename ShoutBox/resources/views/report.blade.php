                       ...
                       <div class="card" style="width: 18rem;">
                          ...
                          @endif
                           <div class="card-body">
                               ...
                               <button class="btn btn-danger" onclick="deleteConfirmation(`{{$report->shoutId}}`)">Delete Report</button>
                               <!-- <button class="btn btn-danger" onclick="deleteshout((`{{$report->shoutId}}`)">Delete</button> -->
                               <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter" onclick="getdetails(`{{$report->shoutId }}`)">View Reasons</button>
