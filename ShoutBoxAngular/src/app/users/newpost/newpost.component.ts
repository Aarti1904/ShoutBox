...
export class NewpostComponent implements OnInit {
  ...
  onFileChanged(event:any){
    ...
    var myarr=this.filedata.type.split("/");
    var reader = new FileReader();
    this.extention=myarr[0].toString();
  
    if((this.extention=="video")||(this.extention=="audio"))
    {
        this.show=true;
...
createFile(f1: NgForm){
  ...
  myFormData.append('caption', this.captionStr);
