...
allComments:any=[]; 
  ...
  constructor(private userService:UserServiceService, private router:Router, private commentService:CommentsService,
    private toaster:ToastrService, private friendService:FriendService,private shoutService:ShoutService, private domSanitizer: DomSanitizer) {
